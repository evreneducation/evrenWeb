...
Geocode.setApiKey("AIzaSyDNQ8d630EqpPMybCwbEMRa3VmtFrrmEOQ");
Geocode.enableDebug();
    ...
    render() {
        ...
        return (
            <div style={{ padding: '1rem', margin: '0 auto', maxWidth: 1000 }}>
                ...
                <AsyncMap
                    googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyDNQ8d630EqpPMybCwbEMRa3VmtFrrmEOQ"
                    loadingElement={
